  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-medium hidden", // put hidden just to hide the label, cuz it make the view looks weird
        ...
        Dropdown: (props) => {
          ...
          if (props.name === "months") {
            ...
            if (earliestYear && latestYear) {
              const yearsLength = formattedLatestYear - earliestYear + 1;
            ...
            return (
              ...
              >
                ...
                <SelectContent key="year">
                  {selectItems.reverse().map((selectItem) => (
                    <SelectItem value={selectItem.value} key={selectItem.value}>
                      {selectItem.label}
                    </SelectItem>
                  ))}
